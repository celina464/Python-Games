...
gunshot_sound = pygame.mixer.Sound("c:\GitHub\Python-Games\Asteroids\music\laser.wav")
print("Loaded gunshot sound.")
print("Playing gunshot sound...")
gunshot_sound.play()
print("Played gunshot sound.")
explosion_sound = pygame.mixer.Sound("c:\GitHub\Python-Games\Asteroids\music\explosion.mp3")
